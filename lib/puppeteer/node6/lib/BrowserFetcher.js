...
const DEFAULT_DOWNLOAD_HOST = 'http://wap_front.dev.sina.cn/marauder';
const downloadURLs = {
...
class BrowserFetcher {
  ...
  canDownload(revision) {
    const url = util.format(downloadURLs[this._platform], this._downloadHost);
  ...
  return new Promise((resolve, reject) => {
    ...
    url = util.format(url, this._downloadHost);
